...
interface SetNotifcationAction {
...
export type ListsAction = AddListAction | GetListAction | GetListByIdAction | SetListToEditAction |
SetListIdToDeleteAction | DeleteListAction | UpdateListAction | SetSelectedListAction | AddTaskAction | DeleteTaskAction | 
SetTaskToDeleteAction | UnsetTaskToDeleteAction | EditTaskAction | SetTaskToEditAction | UnsetTaskToEditAction;

export type NotificationAction = SetNotifcationAction;
