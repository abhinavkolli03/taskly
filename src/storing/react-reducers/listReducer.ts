import { ADD_LIST, GET_LISTS, GET_LIST_BY_ID, SET_LISTID_TO_DELETE, SET_LIST_TO_EDIT,
    DELETE_LIST, UPDATE_LIST, SET_SELECTED_LIST, ADD_TASK, SET_TASK_TO_DELETE, UNSET_TASK_TO_DELETE, 
    DELETE_TASK, UPDATE_TASK, UNSET_TASK_TO_EDIT, SET_TASK_TO_EDIT,
    Lists, ListsAction, ListState } from "../types";
